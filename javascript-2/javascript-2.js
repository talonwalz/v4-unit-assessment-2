...
foods.forEach(elem => elem.calories)
...
const saleProducts = products.map(prodObj => prodObj.price = prodObj.price *= 1.25)
...
const blueProducts = saleProducts.filter(prodObj => prodObj.color === 'blue')
...
let person = {
  name: `Talon`,
  age: 25,
  jobs: [`optometrist`, `web developer`, `fire fighter`],
