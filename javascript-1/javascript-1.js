...
for (let i=0; i<classes.length; i++) {
    for (let key in classes) {
        if (key.includes(`inPerson`)) {
            classes[key] = false;
        } else if (key.includes(`homework`)) {
            classes[key] = false;
        }
    }
}
...
//CODE HERE
   let phone1 = new Phone(`Apple`, `Iphone 11`, 128, `Blue`, false)
  
   let phone2 = new Phone(`Apple`, `Iphone 12 Pro`, 256, `White`, false)
  
   let phone3 = new Phone(`Samsung`, `Galaxy Note 10`, 256, `Grey`, false)
